  ...
  posts: [
    {
      id: 0,
      title: 'callback',
      text: 'Функция, вызываемая для каждого элемента массива arr. Каждый раз, когда callback выполняется, возвращаемое значение добавляется в new_array.',
    },
    {
      id: 1,
      title: 'Мистер бист подал в суд на А4',
      text: 'Влад А4 тупо плагиатил все его идеи и фотошопил его обложки',
    },
  ],
  profile: null,
  status: '',
